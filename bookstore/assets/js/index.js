		...
		<div class="product-thumb">
                                ...
                                ${strPrice}
									...
									<div class="product-btns">
										...
										<button class="primary-btn add-to-cart" title="Add to cart"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
									</div>
								</div>
							</div>
    `);
...
for (var i = 0; i < bestSell.length; i++) {
    ...
    if (bestSell[i].status === 'new') {
        strNew += '<span>New</span>';
    }
    $('#product-slick-2').append(`
	<div class="product product-single">
		<div class="product-thumb">
                                    <div class="product-label">
                                    ${strSale}
...
for (var i = 0; i < bestView.length; i++) {
    ...
    if (bestView[i].status === 'new') {
        strNew += '<span>New</span>';
    }
    $('#product-slick-3').append(`
	<div class="product product-single">
		<div class="product-thumb">
                                    <div class="product-label">
										${strSale}
